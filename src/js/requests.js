...
export function requests() {
  ...
  loginForm.addEventListener("submit", async function (event) {
    ...
    try {
      const response = await fetch(
        "https://n18ot5xx1d.execute-api.us-east-1.amazonaws.com/validate_user",
        {
          method: "POST",
          headers: {
  ...
  registerForm.addEventListener("submit", async function (event) {
    ...
    try {
      const response = await fetch(
        "https://n18ot5xx1d.execute-api.us-east-1.amazonaws.com/create_user",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  async function createInstance() {
    ...
    try {
      const response = await fetch(
        "https://n18ot5xx1d.execute-api.us-east-1.amazonaws.com/create_server",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  async function deleteInstance() {
    ...
    try {
      const response = await fetch(
        "https://n18ot5xx1d.execute-api.us-east-1.amazonaws.com/terminate_server",
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
  ...
  async function stopInstance() {
    ...
    try {
      const response = await fetch(
        "https://n18ot5xx1d.execute-api.us-east-1.amazonaws.com/stop_server",
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
  ...
  async function startInstance() {
    ...
    try {
      const response = await fetch(
        "https://n18ot5xx1d.execute-api.us-east-1.amazonaws.com/start_server",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
